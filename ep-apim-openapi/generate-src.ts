...
// files & dirs
const inputApiSpecFile = 'resources/ep-apim-openapi-spec.json';
const outputOpenApiNodeClientDir = 'src/@solace-labs/ep-apim-openapi-node';
const outputOpenApiBrowserClientDir = 'src/@solace-labs/ep-apim-openapi-browser';
